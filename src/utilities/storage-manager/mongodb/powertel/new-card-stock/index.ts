...
class MongoNewCardStock extends MongoController implements storageManagerInterfaces.powertel.NewCardStock {

  /*****************************************************************/

  protected readonly emitter: storageManagerInterfaces.powertel.newCardStock.Emitter;
  ...
  constructor( params: {
    emitter: storageManagerInterfaces.powertel.newCardStock.Emitter;
  ...
  readonly get = ( filtrationCriteria: storageManagerInterfaces.powertel.newCardStock.FiltrationCriteria, sortCriteria: storageManagerInterfaces.powertel.newCardStock.SortCriteria, limit: number, forceThrow = false ): Promise<interfaces.dataModel.powertel.newCardStock.Super[]> => {
  ...
  readonly addBatch = ( newCardStocks: storageManagerInterfaces.powertel.newCardStock.AddDetails[], forceThrow = false ): Promise<interfaces.dataModel.powertel.newCardStock.Super[]> => {
  ...
  readonly add = ( details: storageManagerInterfaces.powertel.newCardStock.AddDetails, forceThrow = false ): Promise<interfaces.dataModel.powertel.newCardStock.Super> => {
  ...
  readonly update = ( filtrationCriteria: storageManagerInterfaces.powertel.newCardStock.FiltrationCriteria, details: storageManagerInterfaces.powertel.newCardStock.UpdateDetails, forceThrow = false ): Promise<interfaces.dataModel.powertel.newCardStock.Super[]> => {
  ...
  readonly updateById = ( newCardStockId: string, details: storageManagerInterfaces.powertel.newCardStock.UpdateDetails, forceThrow = false ): Promise<interfaces.dataModel.powertel.newCardStock.Super> => {
  ...
  readonly remove = ( filtrationCriteria: storageManagerInterfaces.powertel.newCardStock.FiltrationCriteria, forceThrow = false ): Promise<void> => {
  ...
  private readonly makeConditions = ( filtrationCriteria: storageManagerInterfaces.powertel.newCardStock.FiltrationCriteria ): Promise<QueryConditions> => {
  ...
  private readonly makeSortCriteria = ( sortCriteria: storageManagerInterfaces.powertel.newCardStock.SortCriteria ): Promise<string> => {
  ...
  private readonly generateUpdateDetails = ( document: Model, details: storageManagerInterfaces.powertel.newCardStock.UpdateDetails ): Promise<Model> => {
...
export default ( params: {
  ...
  mapDetails: sharedLogicInterfaces.dataStructures.MapDetails;
  checkThrow: sharedLogicInterfaces.moders.CheckThrow;
} ): storageManagerInterfaces.powertel.NewCardStock => {
