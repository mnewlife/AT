...
class MongoSale extends MongoController implements storageManagerInterfaces.routers.Sale {

  /*****************************************************************/

  protected readonly emitter: storageManagerInterfaces.routers.sale.Emitter;
  ...
  constructor( params: {
    emitter: storageManagerInterfaces.routers.sale.Emitter;
  ...
  readonly get = ( filtrationCriteria: storageManagerInterfaces.routers.sale.FiltrationCriteria, sortCriteria: storageManagerInterfaces.routers.sale.SortCriteria, limit: number, forceThrow = false ): Promise<interfaces.dataModel.routers.sale.Super[]> => {
  ...
  readonly addBatch = ( sales: storageManagerInterfaces.routers.sale.AddDetails[], forceThrow = false ): Promise<interfaces.dataModel.routers.sale.Super[]> => {
  ...
  readonly add = ( details: storageManagerInterfaces.routers.sale.AddDetails, forceThrow = false ): Promise<interfaces.dataModel.routers.sale.Super> => {
  ...
  readonly update = ( filtrationCriteria: storageManagerInterfaces.routers.sale.FiltrationCriteria, details: storageManagerInterfaces.routers.sale.UpdateDetails, forceThrow = false ): Promise<interfaces.dataModel.routers.sale.Super[]> => {
  ...
  readonly updateById = ( saleId: string, details: storageManagerInterfaces.routers.sale.UpdateDetails, forceThrow = false ): Promise<interfaces.dataModel.routers.sale.Super> => {
  ...
  readonly remove = ( filtrationCriteria: storageManagerInterfaces.routers.sale.FiltrationCriteria, forceThrow = false ): Promise<void> => {
  ...
  private readonly makeConditions = ( filtrationCriteria: storageManagerInterfaces.routers.sale.FiltrationCriteria ): Promise<QueryConditions> => {
  ...
  private readonly makeSortCriteria = ( sortCriteria: storageManagerInterfaces.routers.sale.SortCriteria ): Promise<string> => {
  ...
  private readonly generateUpdateDetails = ( document: Model, details: storageManagerInterfaces.routers.sale.UpdateDetails ): Promise<Model> => {
...
export default ( params: {
  ...
  mapDetails: sharedLogicInterfaces.dataStructures.MapDetails;
  checkThrow: sharedLogicInterfaces.moders.CheckThrow;
} ): storageManagerInterfaces.routers.Sale => {
