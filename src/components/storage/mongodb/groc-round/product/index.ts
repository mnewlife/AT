...
class MongoProduct extends MongoController implements storageInterfaces.grocRound.Product {
  ...
  readonly remove = ( filtrationCriteria: storageInterfaces.grocRound.product.FiltrationCriteria, forceThrow = false ): Promise<void> => {
  ...
  private readonly makeConditions = ( filtrationCriteria: storageInterfaces.grocRound.product.FiltrationCriteria ): Promise<QueryConditions> => {
  ...
  private readonly makeSortCriteria = ( sortCriteria: storageInterfaces.grocRound.product.SortCriteria ): Promise<string> => {
  ...
  private readonly generateUpdateDetails = ( document: Model, details: storageInterfaces.grocRound.product.UpdateDetails ): Promise<Model> => {
