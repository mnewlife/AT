...
export type ClassInstance = storage.Generate<FiltrationCriteria, SortCriteria, AddDetails, UpdateDetails, dataModel.grocRound.product.Super, dataModel.grocRound.product.Super[]>;
export type Events = eventGenerator.Generate<"GrocRound|Product", FiltrationCriteria, SortCriteria, AddDetails, UpdateDetails, dataModel.grocRound.product.Super[]>;
