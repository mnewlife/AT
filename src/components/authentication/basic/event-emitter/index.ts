...
import * as events from "../../../../interfaces/components/authentication/events";
...
class AuthenticationEmitter implements authentication.Emitter {
...
export default ( emitEvent: eventManager.Emit ): authentication.Emitter => {
  return new AuthenticationEmitter( emitEvent );
}
