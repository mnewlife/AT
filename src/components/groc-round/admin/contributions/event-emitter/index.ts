...
import * as events from "../../../../../interfaces/events/components/groc-round/admin/contributions/index";
import * as contributionsInterfaces from "../../../../../interfaces/components/groc-round/admin/contributions/index";
...
class ContributionsEmitter implements contributionsInterfaces.Emitter {
  ...
  readonly example = ( data: events.ExampleData ) => {
    ...
    let event: events.Example = {
      context: "GrocRound|Admin|Contributions",
      tags: [],
      identifier: "Example",
      data: {
        user: data.user
