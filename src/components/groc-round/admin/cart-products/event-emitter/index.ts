...
import * as events from "../../../../../interfaces/events/components/groc-round/admin/cart-products/index";
import * as cartProductsInterfaces from "../../../../../interfaces/components/groc-round/admin/cart-products/index";
...
class CartProductsEmitter implements cartProductsInterfaces.Emitter {
  ...
  readonly example = ( data: events.ExampleData ) => {
    ...
    let event: events.Example = {
      context: "GrocRound|Admin|CartProducts",
      tags: [],
      identifier: "Example",
      data: {
        user: data.user
