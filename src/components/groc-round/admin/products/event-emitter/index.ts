...
import * as events from "../../../../../interfaces/events/components/groc-round/admin/products/index";
import * as productsInterfaces from "../../../../../interfaces/components/groc-round/admin/products/index";
...
class ProductsEmitter implements productsInterfaces.Emitter {
  ...
  readonly example = ( data: events.ExampleData ) => {
    ...
    let event: events.Example = {
      context: "GrocRound|Admin|Products",
      tags: [],
      identifier: "Example",
      data: {
        user: data.user
