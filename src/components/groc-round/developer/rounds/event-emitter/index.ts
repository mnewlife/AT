...
import * as events from "../../../../../interfaces/events/components/groc-round/developer/rounds/index";
import * as roundsInterfaces from "../../../../../interfaces/components/groc-round/developer/rounds/index";
...
class RoundsEmitter implements roundsInterfaces.Emitter {
  ...
  readonly example = ( data: events.ExampleData ) => {
    ...
    let event: events.Example = {
      context: "GrocRound|Developer|Rounds",
      tags: [],
      identifier: "Example",
      data: {
        user: data.user
