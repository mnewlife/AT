...
import * as events from "../../../../../interfaces/events/components/groc-round/developer/tracks/index";
import * as tracksInterfaces from "../../../../../interfaces/components/groc-round/developer/tracks/index";
...
class TracksEmitter implements tracksInterfaces.Emitter {
  ...
  readonly example = ( data: events.ExampleData ) => {
    ...
    let event: events.Example = {
      context: "GrocRound|Developer|Tracks",
      tags: [],
      identifier: "Example",
      data: {
        user: data.user
