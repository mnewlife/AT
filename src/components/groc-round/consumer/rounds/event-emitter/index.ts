...
import * as events from "../../../../../interfaces/events/components/groc-round/consumer/rounds/index";
import * as roundsInterfaces from "../../../../../interfaces/components/groc-round/consumer/rounds/index";
...
class RoundsEmitter implements roundsInterfaces.Emitter {
  ...
  readonly example = ( data: events.ExampleData ) => {
    ...
    let event: events.Example = {
      context: "GrocRound|Consumer|Rounds",
      tags: [],
      identifier: "Example",
      data: {
        user: data.user
