...
import * as events from "../../../../../interfaces/events/components/groc-round/consumer/delivery-fees/index";
import * as deliveryFeesInterfaces from "../../../../../interfaces/components/groc-round/consumer/delivery-fees/index";
...
class DeliveryFeesEmitter implements deliveryFeesInterfaces.Emitter {
  ...
  readonly example = ( data: events.ExampleData ) => {
    ...
    let event: events.Example = {
      context: "GrocRound|Consumer|DeliveryFees",
      tags: [],
      identifier: "Example",
      data: {
        user: data.user
