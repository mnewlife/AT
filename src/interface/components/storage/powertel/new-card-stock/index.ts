...
export interface Get {
  ( filtrationCriteria: FiltrationCriteria, sortCriteria: SortCriteria, limit: number, forceThrow?: boolean ): Promise<dataModel.powertel.newCardStock.Super[]>;
}
...
export interface AddBatch {
  ( detailArray: AddDetails[], forceThrow?: boolean ): Promise<dataModel.powertel.newCardStock.Super[]>;
}

export interface Add {
  ( details: AddDetails, forceThrow?: boolean ): Promise<dataModel.powertel.newCardStock.Super>;
}

/******************************************************************************/

export interface Update {
  ( filtrationCriteria: FiltrationCriteria, updates: UpdateDetails, forceThrow?: boolean ): Promise<dataModel.powertel.newCardStock.Super[]>;
}

export interface UpdateById {
  ( newCardStockId: string, updates: UpdateDetails, forceThrow?: boolean ): Promise<dataModel.powertel.newCardStock.Super>;
}
