...
export interface Get {
  ( filtrationCriteria: FiltrationCriteria, sortCriteria: SortCriteria, limit: number, forceThrow?: boolean ): Promise<dataModel.call263.channel.Super[]>;
}
...
export interface AddBatch {
  ( detailArray: AddDetails[], forceThrow?: boolean ): Promise<dataModel.call263.channel.Super[]>;
}

export interface Add {
  ( details: AddDetails, forceThrow?: boolean ): Promise<dataModel.call263.channel.Super>;
}

/******************************************************************************/

export interface Update {
  ( filtrationCriteria: FiltrationCriteria, updates: UpdateDetails, forceThrow?: boolean ): Promise<dataModel.call263.channel.Super[]>;
}

export interface UpdateById {
  ( channelId: string, updates: UpdateDetails, forceThrow?: boolean ): Promise<dataModel.call263.channel.Super>;
}
