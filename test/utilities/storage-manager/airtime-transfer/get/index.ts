  ...
  it( "should emit event upon retrieving airtimeTransfer documents", () => {
    ...
    return storageAirtimeTransfer.get( null, null, null )
      .then(( foundAirtimeTransfers: interfaces.dataModel.AirtimeTransfer[] ) => {
        ...
        let emittedEvent: interfaces.events.utilities.storageManager.airtimeTransfer.Got;
        emittedEvent = emitEventSpy.getCall( 0 ).args[ 0 ];

        expect( emittedEvent ).to.satisfy(( happening: interfaces.events.utilities.storageManager.airtimeTransfer.Got ) => {
  ...
  it( "should emit failed event upon erring", () => {
    ...
    return storageAirtimeTransfer.get( null, null, null, true )
      ...
      .catch(( reason: any ) => {
        ...
        let emittedEvent: interfaces.events.utilities.storageManager.airtimeTransfer.GetFailed;
        emittedEvent = emitEventSpy.getCall( 0 ).args[ 0 ];

        expect( emittedEvent ).to.satisfy(( happening: interfaces.events.utilities.storageManager.airtimeTransfer.GetFailed ) => {
