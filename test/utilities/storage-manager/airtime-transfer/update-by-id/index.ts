  ...
  it( "should emit event upon updating airtimeTransfer document", () => {
    ...
    return storageAirtimeTransfer.updateById( testInstances[ 1 ]._id, {
      ...
      .then(( updatedDocument: AirtimeTransferModel ) => {
        ...
        let emittedEvent: interfaces.events.utilities.storageManager.airtimeTransfer.Updated;
        emittedEvent = emitEventSpy.getCall( 0 ).args[ 0 ];

        expect( emittedEvent ).to.satisfy(( happening: interfaces.events.utilities.storageManager.airtimeTransfer.Updated ) => {
  ...
  it( "should emit failed event upon erring", () => {
    ...
    return storageAirtimeTransfer.updateById( null, null, true )
      ...
      .catch(( reason: any ) => {
        ...
        let emittedEvent: interfaces.events.utilities.storageManager.airtimeTransfer.UpdateFailed;
        emittedEvent = emitEventSpy.getCall( 0 ).args[ 0 ];

        expect( emittedEvent ).to.satisfy(( happening: interfaces.events.utilities.storageManager.airtimeTransfer.UpdateFailed ) => {
