...
export interface Get {
  ...
  ( filtrationCriteria : dataModel.getParams.roundContributor.FiltrationCriteria , sortCriteria : dataModel.getParams.roundContributor.SortCriteria , limit : number ) : Promise<any>;
...
export interface Update {
  ...
  ( filtrationCriteria : dataModel.getParams.roundContributor.FiltrationCriteria , details : any ) : Promise<any>;
...
export interface Remove {
  ...
  ( filtrationCriteria : dataModel.getParams.roundContributor.FiltrationCriteria ) : Promise<any>;
