  ...
  it( "should emit event upon retrieving channel documents", () => {
    ...
    return storageChannel.get( null, null, null )
      .then(( foundChannels: interfaces.dataModel.Channel[] ) => {
        ...
        let emittedEvent: interfaces.events.utilities.storageManager.channel.Got;
        emittedEvent = emitEventSpy.getCall( 0 ).args[ 0 ];

        expect( emittedEvent ).to.satisfy(( happening: interfaces.events.utilities.storageManager.channel.Got ) => {
  ...
  it( "should emit failed event upon erring", () => {
    ...
    return storageChannel.get( null, null, null, true )
      ...
      .catch(( reason: any ) => {
        ...
        let emittedEvent: interfaces.events.utilities.storageManager.channel.GetFailed;
        emittedEvent = emitEventSpy.getCall( 0 ).args[ 0 ];

        expect( emittedEvent ).to.satisfy(( happening: interfaces.events.utilities.storageManager.channel.GetFailed ) => {
