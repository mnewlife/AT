...
describe( "Channel REMOVE", function (): void {
  ...
  it( "should emit event upon removing channel documents", () => {
  ...
  it( "should emit failed event upon erring", () => {
    ...
    return storageChannel.remove( null, true )
      .then(( response: any ) => {
